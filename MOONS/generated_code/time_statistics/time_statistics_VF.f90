       ...
       interface init;   module procedure init_time_statistics_vf;          end interface
       ...
       interface export; module procedure export_wrapper_time_statistics_vf;end interface
       interface import; module procedure import_wrapper_time_statistics_vf;end interface
       ...
       subroutine init_time_statistics_vf(this,that)
         implicit none
       ...
       subroutine export_wrapper_time_statistics_vf(this,dir,name)
         implicit none
         type(time_statistics_vf),intent(in) :: this
       ...
       subroutine import_wrapper_time_statistics_vf(this,dir,name)
         implicit none
         type(time_statistics_vf),intent(inout) :: this
         character(len=*),intent(in) :: dir,name
         integer :: un
