       ...
       subroutine export_STATS_PERIOD(this,un)
         ...
         type(stats_period),intent(in) :: this
         integer,intent(in) :: un
         write(un,*) this%t_start
         write(un,*) this%t_start_actual
         write(un,*) this%t_stop
         write(un,*) this%period
         write(un,*) this%n_stats_collected
         write(un,*) this%compute_stats
         write(un,*) this%define_t_start_actual
         write(un,*) this%t_start_actual_defined
         write(un,*) this%export_stats
       ...
       subroutine import_STATS_PERIOD(this,un)
         ...
         read(un,*) this%t_stop
         read(un,*) this%period
         read(un,*) this%n_stats_collected
         read(un,*) this%compute_stats
         read(un,*) this%define_t_start_actual
         read(un,*) this%t_start_actual_defined
         read(un,*) this%export_stats
