       ...
       subroutine export_clock(this,un)
         ...
         type(clock),intent(in) :: this
         integer,intent(in) :: un
         write(un,*) this%t_elapsed_computational
         write(un,*) this%t_start_computational
         write(un,*) this%t_stop_computational
         write(un,*) this%t_start
         write(un,*) this%t_stop
         write(un,*) this%i_start
         write(un,*) this%i_stop
         write(un,*) this%count_rate
       end subroutine
       ...
       subroutine import_clock(this,un)
         ...
         integer,intent(in) :: un
         call delete(this)
         read(un,*) this%t_elapsed_computational
         read(un,*) this%t_start_computational
         read(un,*) this%t_stop_computational
         read(un,*) this%t_start
         read(un,*) this%t_stop
         read(un,*) this%i_start
         read(un,*) this%i_stop
         read(un,*) this%count_rate
       end subroutine
