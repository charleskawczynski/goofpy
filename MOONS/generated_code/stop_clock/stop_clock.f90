       ...
       subroutine export_stop_clock(this,un)
         ...
         write(un,*) this%seconds_per_step
         write(un,*) this%sim_time_per_sec
         write(un,*) this%t_passed
         write(un,*) this%estimated_total
         write(un,*) this%estimated_remaining
         write(un,*) this%percentage_complete
         write(un,*) this%percentage_complete_wc
         write(un,*) this%t_elapsed
         write(un,*) this%frozen_elapsed
         write(un,*) this%un_plot
       end subroutine
       ...
       subroutine import_stop_clock(this,un)
         ...
         read(un,*) this%seconds_per_step
         read(un,*) this%sim_time_per_sec
         read(un,*) this%t_passed
         read(un,*) this%estimated_total
         read(un,*) this%estimated_remaining
         read(un,*) this%percentage_complete
         read(un,*) this%percentage_complete_wc
         read(un,*) this%t_elapsed
         read(un,*) this%frozen_elapsed
         read(un,*) this%un_plot
       end subroutine
