       ...
       interface init;   module procedure init_many_single_procedure_plane_op;     end interface
       interface delete; module procedure delete_single_procedure_plane_op;        end interface
       interface delete; module procedure delete_many_single_procedure_plane_op;   end interface
       interface display;module procedure display_single_procedure_plane_op;       end interface
       interface display;module procedure display_many_single_procedure_plane_op;  end interface
       interface print;  module procedure print_single_procedure_plane_op;         end interface
       interface print;  module procedure print_many_single_procedure_plane_op;    end interface
       interface export; module procedure export_single_procedure_plane_op;        end interface
       interface export; module procedure export_many_single_procedure_plane_op;   end interface
       interface import; module procedure import_single_procedure_plane_op;        end interface
       interface import; module procedure import_many_single_procedure_plane_op;   end interface
       ...
       subroutine init_many_SINGLE_PROCEDURE_PLANE_OP(this,that)
         implicit none
         type(single_procedure_plane_op),dimension(:),intent(inout) :: this
         type(single_procedure_plane_op),dimension(:),intent(in) :: that
         integer :: i_iter
       ...
       subroutine delete_many_SINGLE_PROCEDURE_PLANE_OP(this)
         implicit none
         type(single_procedure_plane_op),dimension(:),intent(inout) :: this
         integer :: i_iter
       ...
       subroutine display_many_SINGLE_PROCEDURE_PLANE_OP(this,un)
         implicit none
         type(single_procedure_plane_op),dimension(:),intent(in) :: this
         integer,intent(in) :: un
         integer :: i_iter
         if (size(this).gt.0) then
           do i_iter=1,size(this)
       ...
       subroutine print_many_SINGLE_PROCEDURE_PLANE_OP(this)
         implicit none
         type(single_procedure_plane_op),dimension(:),intent(in),allocatable :: this
         call display(this,6)
       end subroutine
       ...
       subroutine export_many_SINGLE_PROCEDURE_PLANE_OP(this,un)
         implicit none
         type(single_procedure_plane_op),dimension(:),intent(in) :: this
         integer,intent(in) :: un
         integer :: i_iter
       ...
       subroutine import_many_SINGLE_PROCEDURE_PLANE_OP(this,un)
         implicit none
         type(single_procedure_plane_op),dimension(:),intent(inout) :: this
         integer,intent(in) :: un
         integer :: i_iter
