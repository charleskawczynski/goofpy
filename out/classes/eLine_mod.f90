       ...
       function setEline(id,BC,a,b,h,k,normalOutward) result(this)
         ...
         real(kind=dp_num), intent(in) :: a
         real(kind=dp_num), intent(in) :: b
         real(kind=dp_num), intent(in) :: h
         real(kind=dp_num), intent(in) :: k
       ...
       subroutine getEline(this,id,BC,a,b,h,k,normalOutward)
         ...
         real(kind=dp_num), intent(out) :: a
         real(kind=dp_num), intent(out) :: b
         real(kind=dp_num), intent(out) :: h
         real(kind=dp_num), intent(out) :: k
