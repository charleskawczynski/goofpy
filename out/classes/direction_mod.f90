       ...
       type direction
         ...
         type(vector) :: instant
         type(vector) :: final
         real(kind=dp_num) :: theta_i
         real(kind=dp_num) :: theta
         real(kind=dp_num) :: theta_f
         real(kind=dp_num) :: phi_i
       endtype
     ...
     &   theta_f,phi_i) result(this)
         ...
         real(kind=dp_num), intent(in) :: theta_i
         real(kind=dp_num), intent(in) :: theta
         real(kind=dp_num), intent(in) :: theta_f
         real(kind=dp_num), intent(in) :: phi_i
     ...
     &   theta,theta_f,phi_i)
         ...
         real(kind=dp_num), intent(out) :: theta_i
         real(kind=dp_num), intent(out) :: theta
         real(kind=dp_num), intent(out) :: theta_f
         real(kind=dp_num), intent(out) :: phi_i
