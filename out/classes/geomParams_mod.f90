       ...
       type geomParams
         ...
         real(kind=dp_num) :: Length2
         real(kind=dp_num) :: Height
         real(kind=dp_num) :: Width
         real(kind=dp_num) :: Diameter_in
         real(kind=dp_num) :: Diameter_out
         real(kind=dp_num) :: a_out
         real(kind=dp_num) :: b_out
         real(kind=dp_num) :: a_in
         real(kind=dp_num) :: b_in
         real(kind=dp_num) :: h_ellipse
         real(kind=dp_num) :: k_ellipse
       endtype
     ...
     &   Diameter_out,a_out,b_out) result(this)
         ...
         real(kind=dp_num), intent(in) :: Length1
         real(kind=dp_num), intent(in) :: Length2
         real(kind=dp_num), intent(in) :: Height
         real(kind=dp_num), intent(in) :: Width
         real(kind=dp_num), intent(in) :: Diameter_in
         real(kind=dp_num), intent(in) :: Diameter_out
         real(kind=dp_num), intent(in) :: a_out
         real(kind=dp_num), intent(in) :: b_out
         ...
         call CalcGeomparamsA_in(this)
         call CalcGeomparamsB_in(this)
         call CalcGeomparamsH_ellipse(this)
         call CalcGeomparamsK_ellipse(this)
       end function
       ...
       subroutine setGeomparamsA_in(this,a_in)
         implicit none
         type(geomParams),intent(inout) :: this
         real(kind=dp_num), intent(in) :: a_in
         this%a_in = a_in
       end subroutine
       ...
       subroutine setGeomparamsB_in(this,b_in)
         implicit none
         type(geomParams),intent(inout) :: this
         real(kind=dp_num), intent(in) :: b_in
         this%b_in = b_in
       end subroutine
       ...
       subroutine setGeomparamsH_ellipse(this,h_ellipse)
         implicit none
         type(geomParams),intent(inout) :: this
         real(kind=dp_num), intent(in) :: h_ellipse
       ...
       subroutine setGeomparamsK_ellipse(this,k_ellipse)
         implicit none
         type(geomParams),intent(inout) :: this
         real(kind=dp_num), intent(in) :: k_ellipse
     ...
     &   k_ellipse)
         implicit none
         type(geomParams),intent(in) :: this
         real(kind=dp_num), intent(out) :: Length1
         real(kind=dp_num), intent(out) :: Length2
         real(kind=dp_num), intent(out) :: Height
         real(kind=dp_num), intent(out) :: Width
         real(kind=dp_num), intent(out) :: Diameter_in
         real(kind=dp_num), intent(out) :: Diameter_out
         real(kind=dp_num), intent(out) :: a_out
         real(kind=dp_num), intent(out) :: b_out
         real(kind=dp_num), intent(out) :: a_in
         real(kind=dp_num), intent(out) :: b_in
         real(kind=dp_num), intent(out) :: h_ellipse
         real(kind=dp_num), intent(out) :: k_ellipse
