       ...
       type BCs
         private
         real(kind=dp_num) :: x_min
         real(kind=dp_num) :: x_max
         real(kind=dp_num) :: y_min
         real(kind=dp_num) :: y_max
         logical :: xmin_IO
         logical :: xmax_IO
         logical :: ymin_IO
         logical :: ymax_IO
     ...
     &   ymax_IO) result(this)
         implicit none
         type(BCs) :: this
         real(kind=dp_num), intent(in) :: x_min
         real(kind=dp_num), intent(in) :: x_max
         real(kind=dp_num), intent(in) :: y_min
         real(kind=dp_num), intent(in) :: y_max
     ...
     &   ymin_IO,ymax_IO)
         implicit none
         type(BCs),intent(in) :: this
         real(kind=dp_num), intent(out) :: x_min
         real(kind=dp_num), intent(out) :: x_max
         real(kind=dp_num), intent(out) :: y_min
         real(kind=dp_num), intent(out) :: y_max
